...
* <strong>We'll look closer at 3 tools today</strong>: [R](https://www.r-project.org/), [Quarto](https://quarto.org/), [Shiny](https://shiny.posit.co/).
...
* A free and open-source _functional_ programming language
...
* Commonly used in the [RStudio IDE](https://posit.co/products/open-source/rstudio/)
   + Install [R](https://www.r-project.org/) _then_ [RStudio](https://posit.co/download/rstudio-desktop/)
:::
...
```{.r code-line-numbers="1|3-18|19-28|30"}
