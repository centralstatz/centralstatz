...
2. Check `projects/<slug>/` and titles for duplicates.
...
6. Keep `order` unique and verify the homepage listing discovers `projects/*/index.qmd` automatically.
...
9. Run `quarto render`.
10. Verify `_site/projects/<slug>/index.html`, homepage card text/image/link, alt text, local assets, headings, and responsive behavior where practical.
