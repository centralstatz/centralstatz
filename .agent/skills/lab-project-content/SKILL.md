...
In apply mode, prepare content for `projects/<slug>/index.qmd`, but do not overwrite an existing page until it has been compared and the change is authorized. Then invoke/read `../lab-project-visual/SKILL.md`.
